    ...
    return (
        <MyModal
            ...
            <div>
                ...
                <div className="paper">
                    <h1>Sustentabilidade em debate 5 - Números detalhados do novo código florestal e suas implicações para os PRAs<span className="publication-date"> Maio / 2017</span></h1>
                ...
                <div className="paper">
                    <h1>Perspectiva Imaflora 3 - Uma análise dos avanços e contradições da agricultura<span className="publication-date"> Novembro / 2016</span></h1>
                ...
                <div className="paper">
                    <h1>Sustentabilidade em debate 3 - A sustentabilidade é um bom negócio para a agricultura<span className="publication-date"> Março / 2016</span></h1>
                ...
                <div className="paper">
                    <h1>Sustentabilidade em debate 3 - Sustainability is good business for agriculture<span className="publication-date"> March / 2016</span></h1>
                ...
                <div className="paper">
                    <h1>Sustentabilidade em debate 2 - A FUNCIONALIDADE DA AGROPECUÁRIA BRASILEIRA (1975 A 2020)<span className="publication-date"> Dezembro / 2015</span></h1>
